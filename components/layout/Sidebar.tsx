...
const Sidebar: React.FC<{ className?: string }> = ({ className = '' }) => {
  ...
  return (
    <aside className={`bg-gradient-to-b from-white to-indigo-50 h-full border-r border-indigo-100 shadow-lg ${className}`}>
      <div className="flex flex-col h-full py-8">
        <div className="px-6 mb-8">
          <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">TimeTracker</h2>
          <p className="text-xs text-indigo-500 mt-1">Manage your time effectively</p>
        </div>
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive 
                    ? 'bg-gradient-to-r from-indigo-100 to-purple-100 text-indigo-700 border-l-2 border-indigo-600 shadow-sm' 
