        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-400">
              Optimize your workflow and maximize productivity with our intuitive time tracking solution.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link href="#" className="text-gray-400 hover:text-white">API</Link>
              </li>
              <li>
                <Link href="#" className="text-gray-400 hover:text-white">Integrations</Link>
              </li>
            </ul>
          </div>
          <div className="col-span-1">
