...
interface ProjectStatusChartWrapperProps {
  data: ProjectSummary;
}

const ProjectStatusChartWrapper: React.FC<ProjectStatusChartWrapperProps> = ({ data }) => {
  const chartData = {
...
export default ProjectStatusChartWrapper; 