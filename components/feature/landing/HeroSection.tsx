...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-10 items-center justify-center rounded-full border-2 bg-white/80 p-2 shadow-[0_0_15px_-10px_rgba(0,0,0,0.7)]",
        className,
      )}
    >
      {children}
...
function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[350px] w-full items-center justify-center overflow-hidden rounded-xl"
      ref={containerRef}
    >
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 lg:gap-8 items-center">
          ...
          <div className="w-full lg:col-span-6 flex flex-col justify-center items-center lg:items-start text-center lg:text-left mt-10 lg:mt-0">
            <div className="w-full max-w-lg">
              <h1 className="text-3xl xs:text-4xl sm:text-5xl tracking-tight text-white mb-4">
                Track Your Time.
                <div className="text-atlantis-400 text-3xl xs:text-4xl sm:text-5xl mt-1">
                  Boost Your <span className="block">Productivity.</span>
                </div>
              </h1>
              <p className="mt-4 text-base xs:text-lg text-white tracking-wide">
