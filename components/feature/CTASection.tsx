  ...
  return (
    <div className="py-16 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-5xl sm:text-6xl font-bold text-lime-400 font-serif mb-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <Link 
            href="#how-it-works" 
            className="rounded-md border border-gray-300 px-6 py-3 text-base font-medium text-gray-300 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:inline-flex sm:items-center"
          >
            See How It Works
          </Link>
        </div>
