...
import { getTaskAssignee, getTaskFollowers, addTaskFollower, removeTaskFollower } from '@/services/taskMembers';
  ...
  actions={
    <div className="flex flex-wrap gap-2">
      ...
      >
        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          {isUserFollowing ? (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 01.52-2.341M7.5 14.5l2.5-2.5m0 0l2.5-2.5M10 12l2.5 2.5M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
          ) : (
        ...
        <Card className="hover:shadow-md transition-shadow duration-200">
          ...
          {task.description ? (
            ...
            <div className="text-center py-8">
              ...
              <h4 className="text-sm font-medium text-gray-900 mb-2">No description provided</h4>
              <p className="text-xs text-gray-500">Add a description to provide more context for this task</p>
            </div>
          )}
        </Card>
          ...
          <div className="space-y-4">
            ...
            {task.totalTimeSpent && (
              <div className="flex items-center justify-between py-2 border-b border-gray-100 last:border-b-0">
                ...
                <span className="text-sm font-medium text-gray-900">{formatDuration(task.totalTimeSpent)}</span>
              </div>
            )}
        ...
        <Card className="hover:shadow-md transition-shadow duration-200">
          ...
          {assigneeLoading ? (
            ...
            <div className="text-center py-6">
              ...
              <p className="text-sm font-medium text-gray-500 mb-1">No assignee</p>
              <p className="text-xs text-gray-400">This task hasn&apos;t been assigned yet</p>
            </div>
          )}
        </Card>
          ...
          {followersLoading ? (
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {followers.map(follower => (
                <div key={follower.id} className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <div className="text-center py-6">
              ...
              <p className="text-sm font-medium text-gray-500 mb-1">No followers</p>
              <p className="text-xs text-gray-400">No one is following this task yet</p>
            </div>
          )}
        </Card>
      </div>
